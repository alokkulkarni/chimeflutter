...
/// Adapts the backend `CallSession` map (as sent over the method channel by Dart) into a Chime
...
///  1. read `meeting`/`attendee` (Dart already unwrapped Connect's `ConnectionData`),
