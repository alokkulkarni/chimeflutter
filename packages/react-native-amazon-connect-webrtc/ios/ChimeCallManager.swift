...
/// Receives call events from the manager. The React Native module implements this and marshals
/// every emission to the main thread before sending it to JS (threading rule, spec §B.2).
